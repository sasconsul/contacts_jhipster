(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('contactsJhipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-contactsJhipsterApp-error');
                var entityKey = httpResponse.headers('X-contactsJhipsterApp-params');
                if (errorHeader) {
